    ...
    <div className="Sort">
      <div className="sort-dropdown">
        ...
        >
          ...
          <Dropdown.Item eventKey="Protein">Protein (Low-High)</Dropdown.Item>
          <Dropdown.Item eventKey="Fat">Fat (Low-High)</Dropdown.Item>
          <Dropdown.Item eventKey="Calories">Calories (Low-High)</Dropdown.Item>
          <Dropdown.Item eventKey="Sugar">Sugar (Low-High)</Dropdown.Item>
        </DropdownButton>
      </div>
    </div>
  );
